...
$checks = [
	...
	'client-side tabs are preserved'             => str_contains( $page, 'data-cb-profiles-tab="general"' ) && str_contains( $page, 'data-cb-profiles-tab="restricted"' ) && str_contains( $page, 'data-cb-profiles-tab="usage"' ),
	'client tab session state is preserved'      => str_contains( $js, "sessionStorage.setItem('cbProfilesAdminTab'" ) && str_contains( $js, "sessionStorage.getItem('cbProfilesAdminTab'" ),
